...
class Ui_SQLCompiler(object):
    def setupUi(self, SQLCompiler):
        ...
        self.inputbox.setStyleSheet(" width: 100%;\n"
"    color: black;\n"
"padding: 14px 14px ;\n"
"  margin: 8px 0;\n"
"  border: 2px solid;\n"
...
"background-color: rgb(226, 250, 195);")
        ...
        self.combilebtn.setStyleSheet("width: 100%;\n"
...
"")
        ...
        self.excutebtn.setStyleSheet("width: 100%;\n"
"  background-color: #4CAF50;\n"
"  color: white;\n"
"  padding: 14px 20px;\n"
"  margin: 8px 0;\n"
...
if __name__ == "__main__":
    ...
    SQLCompiler = QtWidgets.QMainWindow()
    ui = Ui_SQLCompiler()
    ui.setupUi(SQLCompiler)
    SQLCompiler.show()
    sys.exit(app.exec_())
